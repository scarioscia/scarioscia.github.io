...
<figure class="figure">
	<img src="../images/blog_images/photo_geo_extractor/photoGeoExtractor_sample_output.png" alt="">
	<figcaption class="figcaption">Here's an example of the default export, which keeps photo album name, date/time, and GPS directions and coordinates.</figcaption>
</figure><br>
